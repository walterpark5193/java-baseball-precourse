...
public class ManageGame {
    ...
    public static final char REPLAY = '1';

    public int playGame(List<Integer> answer) {
        String input, msg;  //사용자 입력 값, 정답 메시지
        ...
        do {
            ...
            msg = compareAnswer.countAnswer(containCnt, strikeCnt);

            //6. 정답 메시지 출력하는 기능
            compareAnswer.printAnswer(strikeCnt, msg);
